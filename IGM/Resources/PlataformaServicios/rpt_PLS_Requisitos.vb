...
Public Class rpt_PLS_Requisitos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IGM.rpt_PLS_Requisitos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PLS_Requisitos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PLS_Requisitos = New rpt_PLS_Requisitos()
        rpt.Site = Me.Site
        Return rpt
    End Function
