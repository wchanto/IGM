...
Public Class rpt_CentroTrabajo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IGM.rpt_CentroTrabajo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_CentroTrabajo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_CentroTrabajo = New rpt_CentroTrabajo()
        rpt.Site = Me.Site
        Return rpt
    End Function
