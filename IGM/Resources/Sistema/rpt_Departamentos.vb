...
Public Class rpt_Departamentos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IGM.rpt_Departamentos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Departamentos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Departamentos = New rpt_Departamentos()
        rpt.Site = Me.Site
        Return rpt
    End Function
