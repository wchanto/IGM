...
Public Class rpt_RHTiposDeduccion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_RHTiposDeduccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IGM.rpt_RHTiposDeduccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NombreCompania() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_RHTiposDeduccion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_RHTiposDeduccion = New rpt_RHTiposDeduccion()
        rpt.Site = Me.Site
        Return rpt
    End Function
