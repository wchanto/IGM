...
Public Class rpt_RHTiposPago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IGM.rpt_RHTiposPago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_RHTiposPago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_RHTiposPago = New rpt_RHTiposPago()
        rpt.Site = Me.Site
        Return rpt
    End Function
