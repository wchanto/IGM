...
Public Class rpt_RHTipoPlanilla
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IGM.rpt_RHTipoPlanilla.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_RHTipoPlanilla
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_RHTipoPlanilla = New rpt_RHTipoPlanilla()
        rpt.Site = Me.Site
        Return rpt
    End Function
