...
Public Class frm_Menu
    Private Sub CargaOpcionesMenu()
        ...
        'Tributario
        btnOpc6.Visible = False
        Conexion.Open()
        tmpQry.CommandText = "Select * from vw_seg_opcionesMenuUsuario where CodigoOpcion ='03' and CodUsuario=" & MemCodigoUsuario.ToString
        leeSQL = tmpQry.ExecuteReader
        While leeSQL.Read
            btnOpc6.Visible = leeSQL("Visible")
            If btnOpc6.Visible Then
                btnOpc6.Top = Posicion : Posicion = Posicion + 39
            End If
    ...
    Private Sub frm_Menu_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If btnOpc6.Top = 3 Then btnOpc6_Click(sender, e)
    ...
    Private Sub btnOpc6_Click(sender As Object, e As EventArgs) Handles btnOpc6.Click
        LeeOpciones("03", "Tributario       ")
        ImagenMenu.Image = btnOpc6.Image
    End Sub
End Class
