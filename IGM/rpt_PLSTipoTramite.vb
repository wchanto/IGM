...
Public Class rpt_PLSTipoTramite
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IGM.rpt_PLSTipoTramite.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PLSTipoTramite
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PLSTipoTramite = New rpt_PLSTipoTramite()
        rpt.Site = Me.Site
        Return rpt
    End Function
