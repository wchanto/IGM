...
Public Class rpt_PLSRequisitos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IGM.rpt_PLSRequisitos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PLSRequisitos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PLSRequisitos = New rpt_PLSRequisitos()
        rpt.Site = Me.Site
        Return rpt
    End Function
